...
namespace Ingpal.BusinessStore.WebApp.Extension
{
    ...
    public static class TreeSelect
    {
        ...
        {
            StringBuilder sb = new StringBuilder();
            var ChildNodeList = data.Where(t => t.parentId == parentId);
            var tabline = "";
            if (parentId != "")
            {
                tabline = "　　";
    ...
    /// <summary>
    /// Easy UI构建Json数据源的数据格式，属性有id,test,children,这里名字不能够更改否则不能够读取出来
    /// </summary>
    public class EasyComboTreeModel {
        ...
        /// 子类
        /// </summary>
        public List<EasyComboTreeModel> children { get; set; }
